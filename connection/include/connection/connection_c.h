...
__attribute__ ((warn_unused_result)) const char* connection_close(Connection* const conn);
__attribute__ ((warn_unused_result)) const char* connection_begin(Connection* const conn);
__attribute__ ((warn_unused_result)) const char* connection_commit(Connection* const conn);
__attribute__ ((warn_unused_result)) const char* connection_rollback(Connection* const conn);
